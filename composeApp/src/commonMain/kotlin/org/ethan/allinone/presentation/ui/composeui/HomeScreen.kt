            ...
            Column(
                ...
                when (state.value) {
                    is CommonUiState.Success -> {
                        ...
                        (state.value as CommonUiState.Success<ProductsResponse>).data?.let {
                            ProductCard(it.products) { product ->
                    ...
                    is CommonUiState.Error -> {
                        ProgressLoader(isLoading = false)
                        // Handle Error
                        SimpleAlertDialog(message = ((state.value as CommonUiState.Error<ProductsResponse>).message))
                    }
                }
            }
        }
