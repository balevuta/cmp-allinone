...
class HomeViewModel(private val homeRepository: HomeRepository) : BaseViewModel() {
    ...
    private val _uiStateProductDetail = MutableStateFlow<CommonUiState<Product?>>(CommonUiState.Loading)
    val uiStateProductDetail: StateFlow<CommonUiState<Product?>> = _uiStateProductDetail
