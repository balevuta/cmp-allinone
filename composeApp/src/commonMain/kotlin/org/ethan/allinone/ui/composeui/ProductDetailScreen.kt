            ...
            Column(
                ...
                when (state.value) {
                    is UiState.Success -> {
                        ...
                        (state.value as UiState.Success<Product>).data?.let {
                    ...
                    is UiState.Error -> {
                        ProgressLoader(isLoading = false)
                        //Handle Error
                        SimpleAlertDialog(message = ((state.value as UiState.Error<Product>).message))
                    }
                }
            }
        }
...
@Composable
fun ProductDetail(homeViewModel: HomeViewModel, navigator: Navigator, product: Product) {
